...
<!-- 截图占位：Hero 主视觉（首页 Dashboard 全景或三端真机并排，全宽 2:1）—— 后续补 -->
...
<!-- 截图占位：三端真机并排画面（Web UI 同时展示 iOS / Android / HarmonyOS 实时画面，3:1 横拼）—— 后续补 -->
...
<!-- 截图占位：设备别名管理（Web UI 设备页卡片，含别名 + 机型 + 序列号，全宽）—— 后续补 -->
...
<!-- 截图占位：队列 / 并发视图（Web UI 执行队列页，多条 case 并行消费态，全宽）—— 后续补 -->
...
<!-- 截图占位：单设备调试页（右真机画面、左动作日志、底部控制栏，全宽）—— 后续补 -->
...
<!-- 截图占位：HTML 报告（单 case 完整报告：时间线 + 截图 + AI 思考，长截图）—— 后续补 -->
...
<!-- 截图占位：运维大盘（Analytics 页：折线图 + 饼图 + AI 摘要文本区，全宽）—— 后续补 -->
