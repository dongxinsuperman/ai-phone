...
ai-phone 采用 **GNU GPLv3** 开源。Copyright (C) 2026 Dongxin and ai-phone contributors。官方维护入口是 `next/server-brain` 分支；历史 `main` 分支不再作为推荐入口展示或维护。官方分支由原作者维护，是否采纳任何改动由维护者根据项目方向、稳定性和维护成本决定。
